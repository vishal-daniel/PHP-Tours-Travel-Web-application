...
while($data=mysqli_fetch_array($result))
{
		...
		echo "<tr><td style='font-size:18px color:blue padding:10px;'><a href='subcat.php?catid=$data[0]'>$data[1]</a></td></tr>";
...
<?php
$s="select * from package where package.location='" . $_GET["subcatid"] ."'";
$result=mysqli_query($cn,$s);
$r=mysqli_num_rows($result);
//echo $r;
$n=0;
