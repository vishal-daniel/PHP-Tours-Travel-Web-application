...
<!-- <tr><td style="font-family:Lucida Calligraphy; font-size:30px; color:#09F"><b>tour</b></td></tr> -->
<?php
...
?>
		 ...
		 <!-- <div class="col-md-4 about-grids">
			 <h4><span class=""></span>Our Vision</h4>
...
?>
                      ...
                      <tr><td align="left"> <input type="text" class="text" value=" Name"  name="t1" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Your Name';}" required pattern="[a-z A-Z]{1,50}" title"Please Enter Only Characters"></td></tr>
					  <tr><td align="left"> <input type="text" class="text" value=" Booking ID (if applicable)"  name="t5" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Booking ID (if applicable)';}" ></td></tr>
                      <tr><td align="left"><input type="text" class="text" value=" Contact No" name="t2" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Your Contact No.';}" required pattern="[0-9]{8,12}" title"Please Enter Only  numbers between 10 to 12"></td></tr>
					  ...
					  <tr><td><textarea onFocus="if(this.value == 'Message') this.value='';" name="t4" onFocus="if(this.value == '') this.value='Enter Message Here';" required title"Please Enter Only Characters"></textarea></td></tr>
