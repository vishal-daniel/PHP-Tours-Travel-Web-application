...
if(isset($_POST["sbmt"]))
{
	...
	if (empty($_FILES['t3']['name'])) {
		...
		$s="update package set Pack_name='" . $_POST["t1"] ."',Tour='" . $_POST["t2"] . "',Location='" . $_POST["t3"] . "',Price='" . $_POST["t8"] . "',Pic1='" . $_POST["h1"] . "',Pic2='" . $_POST["h2"]. "',Pic3='" .$_POST["h3"] . "',Detail='" . $_POST["t7"] . "' where Pack_id='" . $_POST["s1"] . "'";
...
else
{
	...
	$s="update package set Pack_name='" . $_POST["t1"] ."',Tour='" . $_POST["t2"] . "',Location='" . $_POST["t3"] . "',price='" . $_POST["t8"] . "',Pic1='" .  basename($_FILES["t4"]["name"]) . "',Pic2='" .  basename($_FILES["t5"]["name"]) . "',Pic3='" .  basename($_FILES["t6"]["name"]) . "',Detail='" . $_POST["t7"] . "' where Pack_id='" . $_POST["s1"] . "'";}
	mysqli_query($cn,$s);
	mysqli_close($cn);
...
{
$cn=makeconnection();
$s="select * from package where Pack_id='" .$_POST["s1"] ."'";
$result=mysqli_query($cn,$s);
$r=mysqli_num_rows($result);
//echo $r;
...
<tr><td class="lefttxt">Package Name</td><td><input type="text"  value="<?php if(isset($_POST["show"])){ echo $Pack_name ;} ?> " name="t1" required pattern="[a-zA-z _]{1,50}" title"Please Enter Only Characters between 1 to 50 for Package Name"/></td></tr>
...
<tr><td class="lefttxt">Select Location</td><td><select name="t3" required/><option value="">Select</option>
...
<tr><td class="lefttxt">Package Price</td><td><input type="text" name="t8" value="<?php if(isset($_POST["show"])){ echo $Price ;} ?> " /></td></tr>
