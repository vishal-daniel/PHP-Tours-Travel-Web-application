...
<body>
	...
	if (isset($_POST["sbmt"])) {
		$cn = makeconnection();
		$s = "insert into Tours(Tour_name) values('" . $_POST["t1"] . "')";
		mysqli_query($cn, $s);
		...
		<div class="col-sm-9">
			...
			<form method="post">
				<table border="0" width="90%" height="300px" align="center" class="tableshadow">
					<tr>
						<td class="toptd">View Package</td>
					</tr>
					<tr>
						<td align="center" valign="top" style="padding-top:10px;">
							<table border="0" align="center" width="95%">
								<tr>
									...
									<td style="font-size:15px; padding:5px; font-weight:bold;">Tour ID</td>
									<td style="font-size:15px; padding:5px; font-weight:bold;">Location ID</td>
