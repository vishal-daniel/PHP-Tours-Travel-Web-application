...
<tr><td style="font-size:18px" color="#09F">Tours</td></tr>
<?php
...
<tr><td  colspan="3" height="90px"><span class="middletext">Tour : </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?php echo $data[10];?>
 <br/>
...
<tr><td align="center" colspan="3" height="50px"><a href="check.php?pid=<?php echo $data[0];   ?>"><input type="button" value="BOOK" name="sbmt" /></a></td></tr>
</table>
</td>
</tr>
</table>
