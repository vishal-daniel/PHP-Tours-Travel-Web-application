            ...
            <tr>
              <td>
                ...
                <table border="0" width="600px" height="400px" align="center">
                  ...
                  <tr>
                    <td colspan="3"><span class="middletext">Package Name:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data[1]; ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="3" height="90px"><span class="middletext">Tour : </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <?php echo $data[10]; ?>
                      <br />
                      <span class="middletext">Location : </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <?php echo $data[12]; ?>
                      <br />
                      <span class="middletext">Starting Price : </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <?php echo $data[4]; ?>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center" colspan="3" height="50px"><a href="check.php?pid=<?php echo $data[0];   ?>"><input type="button" value="BOOK" name="sbmt" /></a></td>
                  </tr>
                </table>
              </td>
            </tr>
