		  ...
		  <div class="container">
			 <div class="top-nav">
						...
						<ul id="nav">
                             ...
                             <li><a href="index.php#section-2" onclick="javascript:window.open('category.php','_self')">                                      Tours</a></li>                             
							 <li><a href="index.php#section-4"   onclick="javascript:window.open('index.php#section-4','_self')">                            Hotels</a></li>
