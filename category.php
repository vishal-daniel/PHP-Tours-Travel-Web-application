	...
	<div style="width:1000px; margin:auto">
		...
		<div style="width:200px; float:left">
			...
			<table cellpadding="0" cellspacing="0" width="1000px">
				<tr>
					<td style="font-family:Lucida Calligraphy; font-size:30px; color:#09F"><b>Category</b></td>
				</tr>
				<?php
				...
				while ($data = mysqli_fetch_array($result)) {
					...
					echo "<tr><td style='font-size:20px; padding:5px;'><b><a href='subcat.php?catid=$data[0]'>$data[1]</a></b></td></tr>";
				}
				mysqli_close($cn);
				?>
			...
			<table cellpadding="0px" cellspacing="0" width="1000px">
				...
				<tr>
					<td class="paraText" width="900px">Plan and Book Your Perfect Trip.Create your dream holiday.
						...
						7red rock landscape of the Colorado National Monument. Exhilarating outdoor adventures including
