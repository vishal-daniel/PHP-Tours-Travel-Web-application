...
<tr><td class="headingText" align="center">Locations</td></tr>
<tr><td class="paraText" width="1000px">
...
$s="select * from location where Tour_id='" .$_GET["catid"] . "'";
$result=mysqli_query($cn,$s);
$r=mysqli_num_rows($result);
//echo $r;
$n=0;
...
<tr><td align="center" style="background-color:#60B0E6; font-family:Lucida"><a href="package.php?subcatid=<?php echo $data[0];?>"><font color="#FFFFFF">View Detail</font></a></td></tr>
